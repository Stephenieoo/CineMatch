...
# ============================================
# Group CRUD - Create / Join / Details / Lobby
# ============================================

import json as _json
from django.db import transaction as _transaction
from django.shortcuts import get_object_or_404 as _get_or_404, redirect as _redirect
...
from django.contrib.auth.decorators import login_required as _login_required_alias

# re-use already-imported models
# GroupSession, GroupMember are imported at top of file
...
def get_group_details(request, group_id):
    ...
    try:
        ...
        return _JsonResponse({"success": False, "message": str(e)}, status=500)
...
def group_lobby(request, group_id):
    ...
    try:
        group = _get_or_404(GroupSession, id=group_id, is_active=True)
        ...
        if not membership:
            return _redirect("recom_sys:profile")
        ...
        return _render(request, "recom_sys_app/group_lobby.html", context)
...
def leave_group(request, group_id):
    """
    Leave a group (sets is_active=False).
    POST /api/groups/<uuid:group_id>/leave/
    """
    try:
        group = _get_or_404(GroupSession, id=group_id)
